...
def show_sections(sections, parameters={}):
    ...
    for section in sections:
        ...
        section_host = section[myplex._HOST]
        li = xbmcgui.ListItem(label=section_title)
        section_parameters = {PARAMETER_KEY_MODE: MODE_USERS_VIDEOS, PARAMETER_KEY_URL: PLUGIN_URL + "sections/" + section_title, PARAMETER_KEY_HOST: section_host, PARAMETER_KEY_PERMALINK: section_url, PARAMETER_KEY_TOKEN: section_token}
...
def show_root_menu():
    ...
    # @feature: Add MyPlex Queue, Watched and Unwatched Directory Items
    xbmcplugin.endOfDirectory(handle=handle, succeeded=True)
##################################################################
